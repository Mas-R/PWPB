...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.NotesViewHolder> {
    ...
    public NotesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View vw = LayoutInflater.from(context).inflate(R.layout.note_list, parent,false);
    ...
    public void onBindViewHolder(@NonNull NotesViewHolder holder, final int position) {
        holder.tvDate.setText(noteList.get(position).getTgl());
        holder.tvTitle.setText(noteList.get(position).getName());
